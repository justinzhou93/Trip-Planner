...
$(function () {
    ...
    $hotelSelect = $optionsPanel.find('#hotel-choices');
    $restaurantSelect = $optionsPanel.find('#restaurant-choices');
    $activitySelect = $optionsPanel.find('#activity-choices');
    ...
    makeOption = function(databaseAttraction) {
